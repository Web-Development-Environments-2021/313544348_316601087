...
function Start() {
	...
	var food_5_points_remain = Math.ceil(document.getElementById("balls").value * 0.6);//5 in board
	var food_15_points_remain = Math.ceil(document.getElementById("balls").value * 0.3);//15 in board
	var food_25_points_remain = document.getElementById("balls").value - food_5_points_remain - food_15_points_remain;//25 in board
	var pacman_remain = 1;
	start_time = new Date();
	for (var i = 0; i < 10; i++) {
		board[i] = new Array();
