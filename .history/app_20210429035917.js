...
var musicIsOn;
var endMusic = new Audio('end.mp3');

var listOfGhost = new Array();
var music = new Audio('Keep-Yourself-Alive.mp3');
...
function Start() {
	...
	foodToEat = parseInt(food_remain) + 3;
	lifes = 5;
	board = new Array();
	score = 0;
	pac_color = "yellow";
...
//shayyyy try to fix bug in tut if there's a prom it's here
	...
	function catchPacman(){
			if(PacmanMetghost==true || ghostMetPacman==true){
				lifes--;
				score=score-10;
			}
...
function moveToGame(){
	...
	ghosts_amount = document.getElementById('numOfGhosts').value;
	...
	// // document.getElementById("configuration").style.float=left;
	Start();
}
