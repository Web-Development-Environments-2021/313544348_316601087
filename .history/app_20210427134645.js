...
//          switch(page)     
//             {                
//                case "welcome": html = "Our range of landscaping products<br />";break;    
...
function show(target){
    ...
    document.getElementById(container).innerHTML = document.getElementById(target).innerHTML;//show selected page
