...
function Start() {
	...
	while (food_remain_list.hasOwnProperty("food_5_points_remain") && food_remain_list[food_5_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 5;
			food_remain_list[food_5_points_remain]--;
			food_remain--;
		}
	while (food_remain_list.hasOwnProperty("food_15_points_remain") && food_remain_list[food_15_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 15;
			food_remain_list[food_15_points_remain]--;
			food_remain--;
		}
	while(food_remain_list.hasOwnProperty("food_25_points_remain") && food_remain_list[food_25_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
