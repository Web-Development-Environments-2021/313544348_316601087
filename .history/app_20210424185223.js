...
function random(){
	for ( var i=0; i < document.form1.elements.length; i++ ) {
		if (document.form1.elements[i].type == "range" ) {
			document.form1.elements[i].value = Math.floor(Math.random() * (document.form1.elements[i].max+1 - document.form1.elements[i].min)) + document.form1.elements[i].min;
		}
		...
		if ( document.form1.elements[i].type == "color" ) {
			//Something
		}
