...
var upArrow = 38;
var downArrow = 40;
var ghost_pinki = new Object();
var ghost_redi = new Object();
var ghost_bluei = new Object();
var ghost_yellowi = new Object();

$(document).ready(function() {
	context = canvas.getContext("2d");
	Start();
	//number of balls slider value
	var slider = document.getElementById("balls");
	var output = document.getElementById("numberballs");
	output.innerHTML = slider.value;
	//number of monsters slider value
...
function random(){
	...
	document.getElementById("numberballs").display("block");
	document.getElementById('color5').innerHTML = '#'+(0x1000000+(Math.random())*0xffffff).toString(16).substr(1,6);
	document.getElementById('color15').innerHTML = '#'+(0x1000000+(Math.random())*0xffffff).toString(16).substr(1,6);
	document.getElementById('color25').innerHTML = '#'+(0x1000000+(Math.random())*0xffffff).toString(16).substr(1,6);
	document.getElementById('time').innerHTML = Math.floor(Math.random() * (1000 - 60 + 1) ) + 60;
