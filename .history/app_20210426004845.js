...
function Start() {
		...
		for (var j = 0; j < 10; j++) {
			if (
				...
				if (randomNum <= (1.0 * food_remain) / cnt) {
					if(food_remain_list.hasOwnProperty("food_5_points_remain") && food_5_points_remain == 0){
						delete food_remain_list["food_5_points_remain"];
						// food_5_points_remain--;
						// board[i][j] = 5;
						// food_remain--;
					}
					if(food_remain_list.hasOwnProperty("food_15_points_remain") && food_15_points_remain == 0){
						delete food_remain_list["food_15_points_remain"];
						// food_15_points_remain--;
						// board[i][j] = 15;
						// food_remain--;
					}
					if(food_remain_list.hasOwnProperty("food_25_points_remain") && food_25_points_remain == 0){
	...
	while (food_remain > 0) {
		if (food_remain_list.hasOwnProperty("food_5_points_remain") && food_remain_list[food_5_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 5;
			food_remain_list[food_5_points_remain]--;
			food_remain--;
		}
		else if (food_remain_list.hasOwnProperty("food_15_points_remain") && food_remain_list[food_15_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 15;
			food_remain_list[food_15_points_remain]--;
			food_remain--;
		}
		else if (food_remain_list.hasOwnProperty("food_25_points_remain") && food_remain_list[food_25_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
