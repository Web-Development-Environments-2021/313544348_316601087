...
function Start() {
	...
	pac_color = "yellow";
	var cnt = 100;
	var food_5_points_remain = Math.ceil(document.getElementById("numberballs").value * 0.6);//5 in board
	var food_15_points_remain = Math.ceil(document.getElementById("numberballs").value * 0.3);//15 in board
	...
	var food_remain = document.getElementById("numberballs").value;
	var pacman_remain = 1;
	start_time = new Date();
	for (var i = 0; i < 10; i++) {
		board[i] = new Array();
