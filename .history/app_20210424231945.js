...
function random(){
	var arr = ["right", "left", "up", "down"].concat('abcdefghijklmnopqrstuvwxyz0123456789'.split('')) 
	
	document.getElementById('right').value = arr[Math.floor(Math.random() * arr.length)];
	document.getElementById('left').value = arr[Math.floor(Math.random() * arr.length)];;
	document.getElementById('up').value = arr[Math.floor(Math.random() * arr.length)];;
	document.getElementById('down').value = arr[Math.floor(Math.random() * arr.length)];;
