...
function Start() {
	...
	while (food_remain > 0) {
		...
		if ("food_15_points_remain" in Object.keys(food_remain_list) && food_remain_list[food_15_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 5;
			food_remain_list[food_15_points_remain]--;
			food_remain--;
		}
		if ("food_25_points_remain" in Object.keys(food_remain_list) && food_remain_list[food_25_points_remain] > 0){
			var emptyCell = findRandomEmptyCell(board);
			board[emptyCell[0]][emptyCell[1]] = 5;
