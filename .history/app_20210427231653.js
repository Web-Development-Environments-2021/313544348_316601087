...
function updateAttributes(target){
	// document.getElementById("usernameprint").innerText = document.getElementById("username_login").value;
	replaceText( document.getElementById("usernameprint"), document.getElementById("username_login").value )
	document.getElementById(target).style.display = 'block';//show selected page
