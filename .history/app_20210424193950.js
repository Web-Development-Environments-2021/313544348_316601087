...
function random(){
	...
	document.getElementById('balls').value = Math.random() * (document.getElementById('balls').max - document.getElementById('balls').min +1) + document.getElementById('balls').min;
	...
	document.getElementById('monsters').value = Math.random() * (document.getElementById('monsters').max+1 - document.getElementById('monsters').min +1) + document.getElementById('monsters').min;
