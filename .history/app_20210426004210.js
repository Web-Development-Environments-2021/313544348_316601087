		...
		for (var j = 0; j < 10; j++) {
			if (
				...
				if (randomNum <= (1.0 * food_remain) / cnt) {
					if("food_5_points_remain" in Object.keys(food_remain_list) && food_5_points_remain == 0){
						delete food_remain_list["food_5_points_remain"];
						// food_5_points_remain--;
						// board[i][j] = 5;
						// food_remain--;
					}
					if("food_15_points_remain" in Object.keys(food_remain_list) && food_15_points_remain == 0){
						delete food_remain_list["food_15_points_remain"];
						// food_15_points_remain--;
						// board[i][j] = 15;
						// food_remain--;
					}
					if("food_25_points_remain" in Object.keys(food_remain_list) && food_25_points_remain == 0){
