...
;
var walls = [[1,0],[6,0],[7,0],[8,0],[13,0],[7,1],[2,2],[3,2],[7,2],
			[11,2],[12,2],[1,3],[2,3],[5,3],[9,3],[12,3],[13,3],[4,4],
			[5,4],[6,4],[8,4],[9,4],[10,4],[5,5],[9,5],[0,6],[14,6],
			[0,7],[1,7],[2,7],[7,7],[12,7],[13,7],[14,7],[0,8],[6,8],[7,8],[8,8],
			[14,8],[0,9],[14,9],[4,10],[5,10],[9,10],[10,10],[1,11],[2,11],[5,11],[6,11],
			[8,11],[9,11],[12,11],[13,11],[2,12],[12,12],[0,13],[2,13],[7,13],[12,13],[14,13],
		...
		for (var j = 0; j < boardLength; j++) {
			...
			if (board[i][j] == 2) { //pacman
				...
				{ //left
					...
					context.fill();
					context.beginPath();
					context.arc(center.x - 5, center.y - 15, 5/2, 0,2 * Math.PI); // circle
					context.fillStyle = "black"; //color
					context.fill();
				} 
...
function updateAttributes(target){
	document.getElementById("usernameprint").innerText = "hey" + document.getElementById("username_login").value;
	// replaceText( document.getElementById("usernameprint"), "hey")
	document.getElementById(target).style.display = 'block';//show selected page
