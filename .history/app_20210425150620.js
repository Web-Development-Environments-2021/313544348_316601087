...
function Draw() {
	...
	context.arc(x + width / 3, y + height, width * 0.5, 0, Math.PI);
	context.arc(x + width / 3 - width , y + height, width * 0.5, 0, Math.PI);
	context.arc(x + width / 3 - width / 2 , y + height, width * 0.5, 0, Math.PI);
