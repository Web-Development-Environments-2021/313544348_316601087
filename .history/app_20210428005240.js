	...
	for (var i = 0; i < boardLength; i++) {
		for (var j = 0; j < boardLength; j++) {
			...
			//monsters -  add check pos for animation
				...
				context.drawImage(listOfGhost[0].img , center.x-30, center.y-30 ,30,30);
				
			} else if (board[i][j] == 7) {
				context.drawImage(listOfGhost[1].img, center.x-30, center.y-30 ,30,30);
	
			} else if (board[i][j] == 8) {
				context.drawImage(listOfGhost[2].img, center.x-30, center.y-30 ,30,30);
				
			} else if (board[i][j] == 9) {
				context.drawImage(listOfGhost[3].img, center.x-30, center.y-30 ,30,30);
			}
