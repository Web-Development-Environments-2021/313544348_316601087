...
function Start() {
	...
	pac_color = "yellow";
	var cnt = 100;
	var food_5_points_remain = ceil(document.getElementById("numberballs").value * 0.6);
	var food_15_points_remain = ceil(document.getElementById("numberballs").value * 0.3);
	var food_25_points_remain = document.getElementById("numberballs").value - food_5_points_remain - food_15_points_remain;
	// var food_remain = 50;
	var pacman_remain = 1;
	start_time = new Date();
	for (var i = 0; i < 10; i++) {
