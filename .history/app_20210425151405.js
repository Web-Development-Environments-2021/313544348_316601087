...
function Draw() {
	...
	context.arc(x + width / 2, y + height*2, width * 0.5, 0, Math.PI);
	context.arc(x + width / 2 - width*0.5 , y + height*2, width * 0.5, 0, Math.PI);
	context.arc(x + width / 2 - width , y + height*2, width * 0.5, 0, Math.PI);
